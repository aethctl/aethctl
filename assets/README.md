...
<img align="right" width="300" src="images/system-panel.svg" alt="aethctl system panel" />
...
<img width="49%" src="images/ryoku-desktop.webp" alt="Ryoku desktop" /> <img width="49%" src="images/ryoku-settings.webp" alt="Ryoku settings" />
...
**Nixview**  
A visual system inspector for understanding a NixOS machine without becoming one with `nix-store --query`.
...
<div align="center">
<sub>certified neovim enjoyer · aesthetics &gt; function · this is probably why nothing is ever finished</sub>
<br/><br/>
<code>[ EOF ]</code>
</div>
